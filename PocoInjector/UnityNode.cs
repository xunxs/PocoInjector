...
namespace Poco
{
    public class UnityNode : AbstractNode
    {
        ...
        private object GetRootCanvas(GameObject gameObject)
        {
            // 暂时注释掉 Canvas 相关代码，因为 IL2CPP 版本可能不支持
            // UnityEngine.UI.Canvas canvas = gameObject.GetComponentInParent<UnityEngine.UI.Canvas>();
            object canvas = null;
